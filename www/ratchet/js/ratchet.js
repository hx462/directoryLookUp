...
!(function () {
  ...
  var cacheReplace = function (data, updates) {
    ...
    window.history.replaceState(data.id, data.industry, data.url);
  ...
  var popstate = function (e) {
    ...
    if (activeObj.industry) {
      document.industry = activeObj.industry;
    }
  ...
  var success = function (xhr, options) {
    ...
    if (data.industry) {
      document.industry = data.industry;
    }
  ...
  var parseXHR = function (xhr, options) {
    ...
    data.industry = head.querySelector('industry');
    var text = 'innerText' in data.industry ? 'innerText' : 'textContent';
    data.industry = data.industry && data.industry[text].trim();
